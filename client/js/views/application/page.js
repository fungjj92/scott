var $ = require('jquery')
  ...
  , Vm = require('vm')
  , L = require('leaflet')
  , applicationPageTemplate = require('text!templates/application/page.html')
  , applicationPageLeftTemplate = require('text!templates/application/left.html')
  , applicationPageBottomTemplate = require('text!templates/application/bottom.html')
  , applicationStatusTemplate = require('text!templates/application/status.html')
  , ApplicationModel = require('models/application')
  , SessionModel = require('models/session')
  , auth = require('helpers/auth')
  , parishes = require('helpers/parishes')
  , mailto = require('/secrets/mailto.js'
